...
< 
string ContextSwitchNames[] = {"NUM_LIGHTS", "LOD_BLEND", "INSTANCING_ENABLED", "SHADER_LOD_LEVEL"}; 
...
// Material Parameters
half4 MaterialColour : MaterialColour = half4(1.0f,1.0f,1.0f,1.0f);
// Material-supplied lighting Parameters.
half MaterialDiffuse : MaterialDiffuse = 1.0f;
half MaterialEmissiveness : MaterialEmissiveness = 0.0f;
